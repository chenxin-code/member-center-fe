...
const QualityControlThemeList= () => import('../pages/qualityManagement/theme/qualityControlTheme/qualityControlTheme');
const QualityControlThemeSet= () => import('../pages/qualityManagement/theme/qualityControlTheme/qualityControlThemeSet');

const DecorationInspectionThemeList= () => import('../pages/qualityManagement/theme/decorationInspectionTheme/decorationInspectionTheme');
const DecorationInspectionThemeSet= () => import('../pages/qualityManagement/theme/decorationInspectionTheme/decorationInspectionThemeSet');
...
//质检管理
const QualityInspectionHeadList = () => import('../pages/qualityManagement/qualityinspection/headquarters/headquarters');
const QualityInspectionAddHead = () => import('../pages/qualityManagement/qualityinspection/headquarters/addHeadquarters');
const QualityInspectionDetailHead = () => import('../pages/qualityManagement/qualityinspection/headquarters/detailHeadquarters');
const QualityInspectionResultHead = () => import('../pages/qualityManagement/qualityinspection/headquarters/registrationResults');
const QualityInspectionRectificationHead = () => import('../pages/qualityManagement/qualityinspection/headquarters/initiateCorrective');

const QualityInspectionCityList = () => import('../pages/qualityManagement/qualityinspection/city/cityQualityInspection');
const QualityInspectionDetailCity = () => import('../pages/qualityManagement/qualityinspection/city/detailCityQualityInspection');
const QualityInspectionlResultCity = () => import('../pages/qualityManagement/qualityinspection/city/registrationResults');
const QualityInspectionlRectificationCity = () => import('../pages/qualityManagement/qualityinspection/city/initiateCorrective');
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'hcmUser',
          menuKey: "hcmUser",
          meta: { menu: '/user/hcmUser', authKeys: ["menu_b_user"], bread: [{ path: '/user/hcmUser', name: 'B端用户' }],keepAlive: true },
          component: HcmUser
        },
        {
          ...
          meta: {
            ...
            bread: [{ path: '/user/hcmUser', name: 'B端用户' }, { path: '/user/hcmUser/addHcmUser', name: '添加用户' }]
          },
        ...
        },
        {
          ...
          meta: {
            menu: '/user/hcmUser',
            authKeys: ["menu_b_user"],
            bread: [{ path: '/user/hcmUser', name: 'B端用户' }, { path: '/user/hcmUser/authorizeHcmUser', name: '授权用户' }]
          },
        ...
        },
        {
          ...
          menuKey: "propertyNotice",
          meta: {
            menu: '/propertyNotice', authKeys: ["app_notice"],
            bread: [{ path: '/propertyNotice', name: '物业公告' }, { path: '/propertyNotice/noticeSet', name: '公告设置' }]
          },
          component: NoticeSet
        },
        {
          ...
          meta: {
            menu: '/propertyNotice', authKeys: ["app_notice"],
            bread: [{ path: '/propertyNotice', name: '物业公告' }, { path: '/propertyNotice/propertyDetail', name: '公告详情' }]
          },
        ...
        },
        {
          ...
          meta: {
            ...
            bread: [{ path: '/decorateManagement', name: '装修申请列表' },
        ...
        },
        {
          ...
          meta: {
            menu: '/qualityManagement/inspectionPoint',
            authKeys: ["app_quality"],
            bread: [{ path: '/qualityManagement/inspectionPoint', name: '巡检点管理列表' },
        ...
        },
        {
          ...
          meta: {
            menu: '/qualityManagement/qualityControlTheme',
            authKeys: ["app_quality"],
            bread: [{ path: '/qualityManagement/qualityControlTheme', name: '质检主题列表' },
        ...
        },
        {
          ...
          meta: {
            menu: '/qualityManagement/specialCheckTheme',
            authKeys: ["app_quality"],
            bread: [{ path: '/qualityManagement/specialCheckTheme', name: '专项主题列表' },
        ...
        },
        {
          ...
          meta: {
            menu: '/qualityManagement/decorationInspectionTheme',
            authKeys: ["app_quality"],
            bread: [{ path: '/qualityManagement/decorationInspectionTheme', name: '装修巡查主题列表' },
        ...
        },
        {
          ...
          meta: {
            ...
            authKeys: ["app_quality"],
            bread: [{ path: '/qualityManagement/inspection', name: '巡查管理' },
            { path: '/qualityManagement/inspection/detail/recordDetail/abarbeitungDetail/:id/:standardId/:taskId', name: '发起整改' }]
          },
        ...
        },
        {
          ...
          meta: {
            menu: '/advertise/second/guidePageAppC', authKeys: [""],
            bread: [{ path: '/advertise/second/guidePageAppC', name: 'AppC开屏页列表' }, {
              path: '/advertise/second/guidePageAppCSet',
              name: 'AppC开屏页设置'
            }]
        ...
        },
        {
          ...
          meta: { menu: '/advertise/advertiseArea',keepAlive: true, authKeys: [""], bread: [{ path: '/advertise/advertiseArea', name: '广告区域列表' }] },
        ...
        },
        {
          ...
          props: paramsStorage.setPropsStorage,
          meta: {
            menu: '/advertise/advertiseArea', authKeys: [""],
        ...
        },
        {
          ...
          name: 'popUp',
          menuKey: "popUp",
          meta: { menu: '/advertise/popUp', authKeys: [""], bread: [{ path: '/advertise/popUp', name: '弹窗列表' }],keepAlive: true, },
          component: PopUp
        },
        {
          ...
          props: paramsStorage.setPropsStorage,
          meta: {
            menu: '/advertise/popUp', authKeys: [""],
            bread: [{ path: '/advertise/popUp', name: '弹窗列表' }, { path: '/advertise/popUpSet', name: '弹窗设置' }],
          },
          component: PopUpSet
        },
        {
          ...
          meta: { menu: '/advertise/advertisePush', authKeys: [""], bread: [{ path: '/advertise/advertisePush', name: '广告推送列表' }],keepAlive: true },
        ...
        },
        {
          ...
          props: paramsStorage.setPropsStorage,
          meta: {
            menu: '/advertise/advertisePush', authKeys: [""],
        ...
        },
        {
          ...
          meta: { menu: '/advertise/neighborhoodLife', keepAlive: true,authKeys: [""], bread: [{ path: '/advertise/neighborhoodLife', name: '邻里生活列表' }] },
        ...
        },
        {
          ...
          props: paramsStorage.setPropsStorage,
          meta: {
            menu: '/advertise/neighborhoodLife', authKeys: [""],
        ...
        },
        {
          ...
          props: paramsStorage.setPropsStorage,
          meta: {
            menu: '/advertise/neighborhoodRecommend', authKeys: [""],
            bread: [{
              path: '/advertise/neighborhoodRecommend',
              name: '邻里推荐列表'
        ...
        },
        {
         ...
         meta: {
         menu: '/micro', authKeys: [""],
         bread: [{ path: '/micro', name: '微应用列表' }, { path: '/micro/microApplicationAdd', name: '创建微应用' }]
        },
        ...
        },
        {
          ...
          meta: {
            menu: '/micro', authKeys: [""],
            bread: [{ path: '/micro', name: '微应用列表' }, { path: '/micro/microApplication/microApplicationDetail', name: '微应用详情' }]
          },
        ...
        },
        {
         ...
         meta: {
         menu: '/micro', authKeys: [""],
         bread: [{ path: '/micro', name: '微应用列表' }, { path: '/micro/releaseVersion', name: '微应用版本发布' }]
        },
        ...
        },
        {
          ...
          meta: {
          menu: '/resourcePackage', authKeys: [""],
           bread: [{ path: '/resourcePackage', name: '资源包管理' }, { path: '/resourcePackage/resourcePackageAdd', name: '创建资源包' }]
          },
        ...
        },
        {
          ...
          meta: {
            menu: '/micro', authKeys: [''],
            bread: [{ path: '/micro', name: '微应用列表' }, { path: '/micro/releaseMicroVersion', name: '微应用版本发布' }]
          },
        ...
        // 资源包管理
        {
          ...
          props: paramsStorage.setPropsStorage,
          meta: { menu: '/areaPersonnel', authKeys: [""], bread: [{ path: '/areaPersonnel', name: '区域人员配置列表' }] ,keepAlive: true},
        ...
        },
        {
          ...
          props: paramsStorage.setPropsStorage,
          meta: {
            menu: '/areaPersonnel', authKeys: [""],
            bread: [{ path: '/areaPersonnel', name: '区域人员配置列表' }, { path: '/resourcePackage/areaPersonnelSet', name: '区域人员配置' }]
          },
        ...
        },
        {
          ...
          meta: { menu: '/activity', authKeys: [""], bread: [{ path: '/activity', name: '活动列表' },{ path: '/activity/activitySetFirst', name: '基本信息' }] },
        ...
        },
        {
          ...
          meta: { menu: '/activity', authKeys: [""], bread: [{ path: '/activity/activitySetSecond', name: '活动列表' },{ path: '/activity/activitySetSecond', name: '报名表设置' }] },
        ...
        },
        {
          ...
          meta: { menu: '/visitor', authKeys: [""], bread: [{ path: '/visitor', name: '访客列表' },{ path: '/visitor/visitorDetail', name: '访客详情' }] },
        ...
        },
        {
          ...
          name: 'visitorSet',
          menuKey: "visitorSet",
          meta: { menu: '/visitor', authKeys: [""], bread: [{ path: '/visitor', name: '访客列表' },{ path: '/visitor/visitorSet', name: '访客功能设置' }] },
        ...
        // },
        {
          ...
          menuKey: 'helpCenter',
          meta: {
            menu: '/operationsManagement/helpCenter', authKeys: [''],
        ...
        },
        {
          ...
          meta: {
            menu: '/operationsManagement/helpCenter', authKeys: [''],
            bread: [{ path: '/operationsManagement/helpCenter', name: '帮助中心管理' }, {
        ...
        },
        {
          ...
          meta: {
            menu: '/operationsManagement/productPresentation', authKeys: [''],
        ...
        },
        {
          ...
          meta: {
            menu: '/operationsManagement/businessCooperation', authKeys: [''],
        ...
        },
        {
          ...
          meta: {
            menu: '/operationsManagement/privacyPolicy', authKeys: [''],
        ...
        },
        {
          ...
          meta: {
            menu: '/operationsManagement/mutualCancellation', authKeys: [''],
				...
				},
        {
          ...
          meta: {
            menu: '/version', authKeys: [""],
            bread: [{ path: '/version', name: 'App版本列表' }, { path: '/version/addVersion', name: 'App版本发布' }]
          },
        ...
        },
        {
          ...
          meta: {
            menu: '/releasePass', authKeys: [""],
            bread: [{ path: '/releasePass', name: "放行条审核" },{ path: '/releasePass/addReleasePass', name: '新建放行条' }]
          },
        ...
        },
        {
          ...
          meta: {
            menu: '/releasePass', authKeys: [""],
            bread: [{ path: '/releasePass', name: "放行条审核" },{ path: '/releasePass/releasePassDetail', name: '放行条详情' }]
          },
