...
//1.0空间
const Space = () =>
    import ('../pages/space/space/space');
const SpaceAdd = () =>
    import ('../pages/space/space/addSpace');
const SpaceEdit = () =>
    import ('../pages/space/space/editSpace');
const MainSpaceEdit = () =>
    import ('../pages/space/space/editMainSpace');
//2.0项目
const Project = () =>
    import ('../pages/space/project/project');
const ProjectDetail = () =>
    import ('../pages/space/project/detail');
const ProjectInfo = () =>
    import ('../pages/space/project/projectInfo');
const ProjectInfoMation = () =>
    import ('../pages/space/project/projectnformation');
//3.0标签
const Info = () =>
    import ('../pages/space/info/info');
const Detail = () =>
    import ('../pages/space/info/detail');
