...
HTTP.interceptors.request.use(async config => {
  ...
  // 非login走这个ajax
  let tokenStr =
    'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..U1R2vwNYKTi8HoKM874ZCbKm9A04FcIb5SHrNItED4Sajaq-cJo_203p2YENnq0JzJEgnmIpY-3gw3KJTb831O5-JbZ7chDrqCT2LwrcoJ8hlCAiucIIj1S0ArCmdOMAL8B8qWqTmF44avcKPlR1r-HUHiRAVYUStp7lPw0CdJjtZuq2JsjL1GbNMqnne-jJTOGDsbUs1xuLdaXOPjh_Tm_r5izaaLRTn7g7CqTcuY8SmA3aTFyyhzQBZmKeysogIBxOz8TpfGr4jjNU5smqm2uD7XqJmqRT0-3c1tx6Jy4xeRHj0KEOO7M808cntDZ7yiUu07sKkBfyxbWCN_PioQ';
  console.log(tokenStr);
  config.headers.Authorization = tokenStr;
  return config;
