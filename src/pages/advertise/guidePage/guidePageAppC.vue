<template>
  <div id="guidePageAppC">
    <div class="content-header">AppC开屏页设置</div>
  ...
  export default {
    ...
    mounted () {
      this.$refs.form.setFieldsValue({
        ...
        isDefault: this.formList[4].selectOptions[0]?.id,
      });
    ...
    methods:{
      ...
      onAdd() {
        debounce(()=>{
          this.$router.push({path: "/advertise/second/guidePageAppCSet"})
        })
      },
      //编辑
      onEdit(operation) {
