    ...
    <div class="content-main" ref="content_main">
      <a-row style="padding:20px;height:100%;">
        <a-col flex:auto>
          ...
          />
          <a-modal v-model="visibleAdd" title="添加标签" on-ok="handleOk_add">
            ...
            <a-form layout="inline">
              <a-form-item label="标签名" :validate-status="validateStatus" :help="validateHelp">
                <a-input v-model="addLabel" default-value="" style="width:225px;" @pressEnter="handleOk_add" @change="labelEdit" placeholder="请输入标签名称，最长10个字"/>
              </a-form-item>
            </a-form>
          </a-modal>
          <a-modal v-model="visibleEdit" title="编辑标签" on-ok="handleOk_edit">
            <template slot="footer">
              <a-button key="back" @click="handleCancel">
                取消
              </a-button>
