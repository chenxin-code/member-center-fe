      ...
      <a-row style="padding: 20px; height: 100%">
        ...
        >
          ...
          <a-form-model-item label="照片" prop="fileList">
            <div style="width: 30%">
              <uploadImage :fileList="form.fileList" @click="chooseImg" @onChange="getImgList"></uploadImage>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        fileList: [{ validator: this.checkFile }],
      },
      labelCol: { span: 3 },
      wrapperCol: { span: 20 },
      loading: false,
  ...
  methods: {
    ...
    async checkFile(rule, value, callback) {
      if (this.getImgFlg) {
        let result = await this.getImgList();
      }
      if(value == "") {
