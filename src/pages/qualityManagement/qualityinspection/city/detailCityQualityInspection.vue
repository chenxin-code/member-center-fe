<template>
  <div id="form-container">
    ...
    <StandardDetailsModal :visible="visible" :checkId="checkId" @closeModal="closeModal" />
      ...
      <a-row style="padding:20px;height:100%;">
        <a-row style="margin-top: 20px">
          ...
          >
            <a-row>
              <a-col :span="8">
                <a-form-model-item label="主题">{{checkTask.themeName}}</a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item
                  label="专业线"
                >{{checkTask.specialLineName}}</a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="项目">{{checkTask.projectName}}</a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="城市公司">{{checkTask.cityName}}</a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="年份">{{checkTask.year}}</a-form-model-item>
              </a-col>
              <!-- <a-col :span="8">
                <a-form-model-item label="季度">{{checkTask.quarter}}</a-form-model-item>
              </a-col> -->
              <a-col :span="8">
        ...
        <a-tabs type="card" @change="changeTab">
          <a-tab-pane key="1" tab="质检记录">
            <a-card>
              <span style="color:'#666';margin-bottom:10px;display:block">分数：{{scoreSum?scoreSum:'0'}}/{{totalScoreSum?totalScoreSum:'0'}}</span>
              <QualityRecord
