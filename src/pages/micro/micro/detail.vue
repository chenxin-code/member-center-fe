<template>
  <div id="microDetail">
    <div class="content-header">微应用详情
...
export default {
  ...
  methods: {
    ...
    getMicroDetail () {
      ...
      api.microApplicationDetail(para).then(res => {
        if (res.code === 200) {
          this.microApplicationDetail = res.data;
          if (this.microApplicationDetail.icon == undefined) {
            this.microApplicationDetail.icon = 'https://ns-strategy.cdn.bcebos.com/ns-strategy/upload/fc_big_pic/part-00408-1094.jpg';
          }
        }
      }).finally(() => {
    ...
    getVersionsDataSource () {
      ...
      api.getMicroApplicationVersion(para).then(res => {
        if (res.code === 200) {
